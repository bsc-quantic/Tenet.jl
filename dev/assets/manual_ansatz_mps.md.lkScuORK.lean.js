import{_ as n,c as s,a5 as e,o as t}from"./chunks/framework.Cn53cJ0c.js";const h=JSON.parse('{"title":"Matrix Product States (MPS)","description":"","frontmatter":{},"headers":[],"relativePath":"manual/ansatz/mps.md","filePath":"manual/ansatz/mps.md","lastUpdated":null}'),i={name:"manual/ansatz/mps.md"};function p(o,a,r,d,l,c){return t(),s("div",null,a[0]||(a[0]=[e(`<h1 id="Matrix-Product-States-(MPS)" tabindex="-1">Matrix Product States (MPS) <a class="header-anchor" href="#Matrix-Product-States-(MPS)" aria-label="Permalink to &quot;Matrix Product States (MPS) {#Matrix-Product-States-(MPS)}&quot;">​</a></h1><p>Matrix Product States (MPS) are a Quantum Tensor Network ansatz whose tensors are laid out in a 1D chain. Due to this, these networks are also known as <em>Tensor Trains</em> in other mathematical fields. Depending on the boundary conditions, the chains can be open or closed (i.e. periodic boundary conditions).</p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>fig = Figure() # hide</span></span>
